...
POSE_DELTAS = {
    ...
    # ── V8.16: X/Y 平移预设 (多姿态鲁棒性验证) ──
    "x_p30": {
        "dx": 0.030, "dy": 0.0, "dz": 0.0,
        "rp_deg": [0, 0, 0],
        "desc": "X +30mm",
    },
    "x_m30": {
    ...
    # 边界探索: 组合平移
    "combo_xm50_ym40": {
        "dx": -0.050, "dy": -0.040, "dz": 0.0,
        "rp_deg": [0, 0, 0],
        "desc": "X-50mm Y-40mm boundary",
    },
    "yaw_p15_xy": {
        "dx": 0.020, "dy": -0.020, "dz": 0.0,
        "rp_deg": [0, 0, 15],
        "desc": "Yaw+15 with minor XY shift",
    },
}
