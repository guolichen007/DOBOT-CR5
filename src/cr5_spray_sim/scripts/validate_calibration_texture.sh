...
#
# 用法:
#   bash run_calibration_texture_check.sh [--gui]
# ===========================================================================
set -euo pipefail
...
# 验证关键文件
SMOKE_WORLD="$PKG_DIR/worlds/calibration_texture_check.world"
DAE_MESH="$PKG_DIR/models/calibration_target/meshes/panel_unit.dae"
MAT_SCRIPT="$PKG_DIR/models/calibration_target/materials/scripts/calibration_target.material"
FRONT_TEX="$PKG_DIR/models/calibration_target/materials/textures/charuco_front.png"
...
cleanup() {
    ...
    pkill -f "calibration_texture_check" 2>/dev/null || true
}
trap cleanup EXIT
